...
export function MagicCard(props: MagicCardProps) {
  ...
  const gradientColor = propGradientColor ?? (isDarkTheme ? "rgba(59, 130, 246, 0.15)" : "rgba(59, 130, 246, 0.08)")
  const gradientFrom = propGradientFrom ?? (isDarkTheme ? "#3b82f6" : "#93c5fd")
  const gradientTo = propGradientTo ?? (isDarkTheme ? "#2563eb" : "#60a5fa")

  const glowFrom = isOrbMode(props) ? (props.glowFrom ?? (isDarkTheme ? "#3b82f6" : "#93c5fd")) : (isDarkTheme ? "#3b82f6" : "#93c5fd")
  const glowTo = isOrbMode(props) ? (props.glowTo ?? (isDarkTheme ? "#2563eb" : "#60a5fa")) : (isDarkTheme ? "#2563eb" : "#60a5fa")
